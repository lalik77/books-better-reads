...
import com.mami.betterreads.search.SearchResult;
import com.mami.betterreads.search.SearchResultBook;
  ...
  public SearchController(WebClient.Builder webClientBuilder) {
    this.webClient = webClientBuilder
        .exchangeStrategies(ExchangeStrategies.builder()
            ...
            .build())
        .baseUrl("openlibrary.org/search.json")
        .build();
  }
  ...
  public String getSearchResults(@RequestParam String query, Model model) {
    ...
    List<SearchResultBook> books = result.getDocs().stream()
        ...
        .map(bookResult -> {
          ...
          }else coverId="/images/no-image.png";
